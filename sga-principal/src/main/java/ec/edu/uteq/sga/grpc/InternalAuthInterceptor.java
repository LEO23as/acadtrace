...
public class InternalAuthInterceptor implements ServerInterceptor {
    ...
    // TODO: Usar variable de entorno para producción, hardcodeado por ahora como "***REMOVED-GRPC-TOKEN***"
    private static final String EXPECTED_TOKEN = "***REMOVED-GRPC-TOKEN***";
