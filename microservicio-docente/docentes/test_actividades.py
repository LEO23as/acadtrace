...
@pytest.mark.parametrize(("metadata", "validation", "code"), [
    ...
    ((("internal_token", "***REMOVED-GRPC-TOKEN***"),), {"is_valid": True}, grpc.StatusCode.UNAUTHENTICATED),
    ((("docente_id", "10"), ("internal_token", "***REMOVED-GRPC-TOKEN***")), {"is_valid": False}, grpc.StatusCode.PERMISSION_DENIED),
])
...
def test_autorizacion_actividad_valida(mock_validate):
    context = DummyContext((("docente_id", "10"), ("internal_token", "***REMOVED-GRPC-TOKEN***")))
