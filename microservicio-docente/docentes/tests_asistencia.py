...
def auth_context(token="***REMOVED-GRPC-TOKEN***", docente="10"):
...
@pytest.mark.parametrize("context", [auth_context(token="malo"), DummyContext((("internal_token", "***REMOVED-GRPC-TOKEN***"),))])
