  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 px-4">
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl overflow-hidden relative z-10">
        {/* Header azul — idéntico a sga-principal */}
        <div className="bg-[#243A76] px-8 pt-8 pb-6 flex flex-col items-center">
          ...
          {/* Badge secretaría */}
          <span className="mt-3 px-3 py-0.5 bg-white/10 rounded-full text-white/80 text-xs font-medium border border-white/20">
            Panel Secretaría
          </span>
        </div>
        ...
        <div className="px-8 py-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange} placeholder="Ingresa tu usuario" required
            ...
            {/* Contraseña */}
            <div>
              <label className="block text-xs font-semibold text-slate-500 mb-1 uppercase tracking-wide">Contraseña</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">
            ...
            <button type="submit" disabled={loading}
              className="w-full bg-[#243A76] hover:bg-[#1a2d5f] text-white font-semibold py-2.5 rounded-lg text-sm transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed mt-2">
              {loading
